...
## `TerminalRenderer`
### 字体颜色与样式对照表
- fore_color : {'default' : 默认, 'blue' : 蓝色, 'red' : 红色, 'yellow' : 黄色, 'green' : 绿色, 'cyan' : 青色, 'magenta' : 洋红色, 'black' : 黑色, 'white' : 白色}
- back_color : {'default' : 默认, 'blue' : 蓝色, 'red' : 红色, 'yellow' : 黄色, 'green' : 绿色, 'cyan' : 青色, 'magenta' : 洋红色, 'black' : 黑色, 'white' : 白色}
...
- `back_color` -> 背景色
- `style` -> 样式
### `void render((str, str): origin_colors=('default', 'default'), bool: clear_window=True)`
渲染已放置的文本
- `origin_colors` -> 空白部分的默认前景色与背景色
